...
#ifndef SIXPHASESSUMCDOTHSQUARE_H
#define SIXPHASESSUMCDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class SixPhasesSumCdothsquare;

template <>
InputParameters validParams<SixPhasesSumCdothsquare>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class SixPhasesSumCdothsquare : public AuxKernel
{
public:
  SixPhasesSumCdothsquare(const InputParameters & parameters);
...
#endif // SIXPHASESSUMCDOTHSQUARE_H
