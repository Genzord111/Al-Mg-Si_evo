...
#include "SixPhasesSumCdothsquare.h"

registerMooseObject("newtApp", SixPhasesSumCdothsquare);

template <>
InputParameters
validParams<SixPhasesSumCdothsquare>()
{
  ...
  params.addRequiredParam<MaterialPropertyName>("h6_name","Switching function of gas");
...
SixPhasesSumCdothsquare::SixPhasesSumCdothsquare(const InputParameters & parameters)
...
Real
SixPhasesSumCdothsquare::computeValue()
{
  ...
  return _var1[_qp]*(_prop_h1[_qp]*_prop_h1[_qp]+_prop_h2[_qp]*_prop_h2[_qp]+_prop_h3[_qp]*_prop_h3[_qp]+_prop_h4[_qp]*_prop_h4[_qp]+_prop_h5[_qp]*_prop_h5[_qp]+_prop_h6[_qp]*_prop_h6[_qp]) ;
}
